...
ms :: Grids
ms =    [[08,02,22,97,38,15,00,40,00,75,04,05,07,78,52,12,50,77,91,08]
...
pack4 :: [Int] -> Grids
pack4 xs = [ take 4 ls | ls <- tails xs, length ls > 3]
...
fourGrids :: [Grids]
fourGrids = [f ms | f <- [id, transpose, reverse, transpose . reverse]]
